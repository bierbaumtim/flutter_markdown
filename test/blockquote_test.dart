  ...
  group('Blockquote', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(styledTextParts[0].style.color, theme.textTheme.bodyText2.color);
        ...
        expect(styledTextParts[2].style.color, theme.textTheme.bodyText2.color);
        ...
        expect(styledTextParts[4].style.color, theme.textTheme.bodyText2.color);
